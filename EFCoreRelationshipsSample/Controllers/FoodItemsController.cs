...
namespace EFCoreRelationshipsSample.Controllers
{
    public class FoodItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price")] FoodItem foodItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price")] FoodItem foodItem)
        {
            if (id != foodItem.Id)
            {
                return NotFound();
